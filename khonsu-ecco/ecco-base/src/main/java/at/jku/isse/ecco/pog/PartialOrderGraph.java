...
public interface PartialOrderGraph extends Persistable {
	...
	public interface Op extends PartialOrderGraph {
		 ...
		 */
		public default void align(Op other) {
...
//		}
		...
		//private
		default void alignMemoizedBacktracking(Op other) {
			// matrix that stores the maps of matching nodes (sequence numbers to matching right nodes)
...
//		}
		 ...
		 */
		public default void merge(Op other) {
...
//				}
		...
		public default void copy(Op other) {
			...
			Map<Node.Op, Node.Op> matches = new HashMap<>();
		 ...
		 */
		//private
		default void checkAlignment(Op other, Map<Integer, Node.Op> shared) {
		 ...
		 */
		//private
		default Op fromList(List<? extends Artifact.Op<?>> artifacts) {
			Op other = this.createPartialOrderGraph(); // create new partial order graph
